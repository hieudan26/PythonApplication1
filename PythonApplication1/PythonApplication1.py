...
class CaNhan():
    ...
    def __init__(self, HoTen="", NgayGiaNhap = datetime.datetime.now(), ThoiGianHopDong = 0, LuongCoBan = 0, CMND = "", NamSinh = "", Nghe= "",hesoluong = 1):
        self.sHoTen = HoTen
...
class BacSi(CaNhan):
    def __init__(self, HoTen="", NgayGiaNhap = datetime.datetime.now(), ThoiGianHopDong = 0, LuongCoBan = 0, CMND = "", NamSinh = "", Nghe= "BacSi",Rank= "", TruongDaoTao= ""):
...
class CauThu(CaNhan):
    def __init__(self, HoTen="", NgayGiaNhap = datetime.datetime.now(), ThoiGianHopDong = 0, LuongCoBan = 0, CMND = "", NamSinh = "", Nghe= "CauThu",SoAo = 0, TinhTrangTheLuc = 0, TinhTrangSucKhoe = 0, ChanThuan = "trai", ViTriDaChinh= ""):
        super().__init__(self,HoTen, NgayGiaNhap, ThoiGianHopDong, LuongCoBan, CMND, NamSinh, Nghe)
...
class HLVChienThuat(CaNhan):
    def __init__(self, HoTen="", NgayGiaNhap = datetime.datetime.now(), ThoiGianHopDong = 0, LuongCoBan = 0, CMND = "", NamSinh = "", Nghe= "HLVCT",Rank= 0, QuocGia= "", KinhNghiem = 0):
        super().__init__(self,HoTen, NgayGiaNhap, ThoiGianHopDong, LuongCoBan, CMND, NamSinh, Nghe)
        self.hesoluong = float(1.3)
        self.sRank = Rank
...
class HLVTheLuc(CaNhan):
    def __init__(self, HoTen="", NgayGiaNhap = datetime.datetime.now(), ThoiGianHopDong = 0, LuongCoBan = 0, CMND = "", NamSinh = "", Nghe= "HLVTL",ChiSoNangCaoTL = 0, NoiSinh = ""):
        super().__init__(self,HoTen, NgayGiaNhap, ThoiGianHopDong, LuongCoBan, CMND, NamSinh, Nghe)
        self.hesoluong = float(1.3)
...
class NVBaoVe(CaNhan):
    def __init__(self, HoTen="", NgayGiaNhap = datetime.datetime.now(), ThoiGianHopDong = 0, LuongCoBan = 0, CMND = "", NamSinh = "", Nghe= "BaoVe",ThoiGianLamTrongNgay = 0, MauDongPhuc = ""):
        super().__init__(self,HoTen, NgayGiaNhap, ThoiGianHopDong, LuongCoBan, CMND, NamSinh, Nghe)
...
class NVVeSinh(CaNhan):
    def __init__(self, HoTen="", NgayGiaNhap = datetime.datetime.now(), ThoiGianHopDong = 0, LuongCoBan = 0, CMND = "", NamSinh = "", Nghe= "VeSinh",Shift = 0, Thuong = 0):
        super().__init__(self,HoTen, NgayGiaNhap, ThoiGianHopDong, LuongCoBan, CMND, NamSinh, Nghe)
        self.hesoluong = float(1.0)
...
class DoiBong:
    def __init__(self, TenDoiBong = "",TenNhaTaiTro = "",san = San(),CauThus = QuanLyCauThu(),Nhanviens = QuanLyNhanVien()):
